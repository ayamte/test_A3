...
public class AuthenticationService {
    ...
    private void sendVerificationEmail(User user) {
        String subject = "Vérification de compte Wasalny";
        String verificationCode = "CODE DE VÉRIFICATION : " + user.getVerificationCode();
        String htmlMessage = "<html>"
                + "<body style=\"font-family: Arial, sans-serif;\">"
                + "<div style=\"background-color: #f5f5f5; padding: 20px;\">"
                + "<h2 style=\"color: #333;\">Bienvenue sur Wasalny !</h2>"
                + "<p style=\"font-size: 16px;\">Veuillez entrer le code de vérification ci-dessous pour continuer :</p>"
